...
* combines all TinyMCE js files into 1 .js file (must faster editor loading)
* provides form helpers (all 3 varieties)
* makes it simple to lazy load TinyMCE

== Installation

1. Download and install this plugin into vendor/plugins/tinymce_hammer
2. Download TinyMCE (http://tinymce.moxiecode.com/download.php) and place here:

     RAILS_ROOT/public/javascript/tiny_mce

   If you want to move your TinyMCE installation to a different directory, 
