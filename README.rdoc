...
== AJAX Example:
	...
	You cannot use the tinymce textarea form helper when using this initializing method, but you can
	add your own classname to your textarea and pass this as parameter to the init_tinymce() helper.
